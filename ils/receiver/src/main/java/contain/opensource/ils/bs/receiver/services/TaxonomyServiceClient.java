...
public class TaxonomyServiceClient {
    ...
    public String GetTaxLabel(String markingID) {
        if (markingID == null || markingID.isBlank()) {
        ...
        String uri = String.format("%s/gettaxonomyLabelFromGuid?guid=%s&lang=en", baseUrl, markingID);
