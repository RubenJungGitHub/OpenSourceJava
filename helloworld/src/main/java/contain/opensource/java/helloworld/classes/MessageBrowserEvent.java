...
public class MessageBrowserEvent {
    public static void ReadMessages(String[] args) {
        try {
            ...
            //Queue queue = session.createQueue("http://localhost:8161/admin/browse.jsp?JMSDestination=Consumer.01212fbf-b2c3-3779-8bda-19738e300ada.VirtualTopic.alfresco.repo.events.nodes");
            Queue queue = session.createQueue("Consumer.01212fbf-b2c3-3779-8bda-19738e300ada.VirtualTopic.alfresco.repo.events.nodes");
